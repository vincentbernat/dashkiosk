    ...
    return sequelize
      ...
      .then(function() {
        ...
        return g.create()
          .then(function() {
            return g
              .addDashboard('https://play.grafana.org/dashboard/db/alerting?kiosk',
                            { description: 'Grafana Alerts',
                              timeout: 120 });
          })
          .then(function() {
            return g
              .addDashboard('https://play.grafana.org/dashboard/db/prometheus-demo-dashboard?kiosk',
                            { description: 'Promotheus Demo',
                              timeout: 120 });
          })
          .then(function() {
            return g
              .addDashboard('https://play.grafana.org/dashboard/db/elasticsearch-metrics?kiosk',
