...
function handleNewDisplay(bus, io) {
    ...
    socket.on('register', function(data, fn) {
      ...
      models.Display.register(name)
        .then(function(display) {
          ...
          logger.info('registered display', name);

          // Join the appropriate rooms and listen to the appropriate events
          ...
          // Tell everybody about our new member
...
function handleGroupDashboard(bus, io) {
...
module.exports = function(bus, io) {
  handleNewDisplay(bus, io);
  handleGroupDashboard(bus, io);
};
