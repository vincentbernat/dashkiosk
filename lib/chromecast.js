...
var homeIds = ['00000000-0000-0000-0000-000000000000', 'E8C28D3C'],
    ...
    dashkioskReceiver = config.get('chromecast:receiver');
...
module.exports = function() {
  ...
  // Check we have a receiver
  if (!dashkioskReceiver) {
    throw new Error('For chromecast support, a receiver must be specified');
  }
  if (!(/^https?:\/\//.test(dashkioskReceiver))) {
    logger.warn('Receiver URL should be a fully qualified URL!');
    dashkioskReceiver = 'http://' + dashkioskReceiver;
  }
